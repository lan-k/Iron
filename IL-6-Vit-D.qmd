...
Descriptive Statistics for 25(OH)D3, HMAD and EPDS at screening, 6 weeks and 12 months, inclduing only participants without missing data for any of the three variables.
...
There was a significant difference in the total effect and average direct effect (ADE) between the 500mg and 100mg groups on HAM-D. However, there was no significant average causal mediation effect (ACME) from 25(OH)D3 on HAMD at 6 weeks or over 12 months.
...
plot(hamd_dep_25ohd3_fu1$medfit,  main = "6 weeks",xlim = c(-4,1),
    treatment = "treated",
     # labels  =c("Indirect","Direct" ,"Total"),
     xlab = "Change in HAM-D from baseline (500mg-1000mg)")

plot(hamd_dep_25ohd3_fu2$medfit,  main = "12 months",xlim = c(-4,1),
    treatment = "treated",
     #labels  =c("Indirect","Direct" ,"Total"), 
     xlab = "Change in HAM-D from baseline (500mg-1000mg)")
