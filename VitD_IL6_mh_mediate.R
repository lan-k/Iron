...
df_hamd_dep_25ohd3 = bind_rows(df_hamd_dep_25ohd3_fu1 %>% mutate(timept = "FU1"),
...
df_epds_25ohd3 = bind_rows(df_epds_25ohd3_fu1 %>% mutate(timept = "FU1"),
                               df_epds_25ohd3_fu2 %>% 
                             mutate(timept = "FU2",
                                    Outcome="", Mediator = "") )
...
df_hamd_dep_il6 = bind_rows(df_hamd_dep_il6_fu1 %>% mutate(timept = "FU1"),
                               df_hamd_dep_il6_fu2 %>% 
                              mutate(timept = "FU2",
                                     Outcome="", Mediator = ""))
...
df_epds_il6 = bind_rows(df_epds_il6_fu1 %>% mutate(timept = "FU1"),
                        df_epds_il6_fu2 %>% 
                          mutate(timept = "FU2",
                                 Outcome="", Mediator = "") )
